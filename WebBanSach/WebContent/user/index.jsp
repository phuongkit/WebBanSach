                ...
                <div class="khoisanpham" style="padding-bottom: 2rem;">
                    ...
                    <div class="card">
                        <a href="Lap-trinh-ke-hoach-kinh-doanh-hieu-qua.html" class="motsanpham"
                            ...
                            <img class="card-img-top anh" src="user/images/lap-ke-hoach-kinh-doanh-hieu-qua.jpg"
                    ...
                    <div class="card">
                        ...
                        Tình Thân (Bộ 8 Cuốn)">
                            <img class="card-img-top anh" src="user/images/bo-sach-500-cau-chuyen-dao-duc.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/ung-thu-hoang-de-cua-bach-benh.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/troi-dem-huyen-dieu.jpg"
                ...
                <div class="khoisanpham">
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/combo-chuyen-nghe-chuyen-doi.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/combo-me-con-su-tu-bo-tat-ngan-tay-ngan-mat.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/combo-hanh-phuc-sang-tao.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/combo-giao-duc-va-y-nghia-cuoc-song.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/combo-dinh-duong-than-duoc-xanh.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/combo-an-xanh-song-lanh.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/combo-luoc-su-loai-nguoi.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/combo-phong-cach-song.jpg"
                ...
                <div class="khoisanpham">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/ngoai-giao-cua-chinh-quyen-sai-gon.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/duong-may-tren-dat-hoa.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/muon-kiep-nhan-sinh.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <img class="card-img-top anh" src="user/images/duong-may-trong-coi-mong.jpg"
                    ...
                    <div class="col-lg col-sm-4">
                        <div class="card">
                            <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                                ...
                                <img class="card-img-top anh" src="user/images/tung-buoc-chan-no-hoa.jpg"
                    ...
                    <div class="col-lg col-sm-4">
                        <div class="card">
                            <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                                ...
                                <img class="card-img-top anh" src="user/images/cam-on-vi-da-duoc-thuong.jpg"
                    ...
                    <div class="col-lg col-sm-4">
                        <div class="card">
                            <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                                ...
                                <img class="card-img-top anh" src="user/images/vua-gia-long.jpg" alt="vua-gia-long">
                                <div class="card-body noidungsp mt-3">
                    ...
                    <div class="col-lg col-sm-4">
                        <div class="card">
                            <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                                ...
                                <img class="card-img-top anh" src="user/images/suoi-nguon-va-cai-toi-trong-tung-ca-the.jpg"
                    ...
                    <div class="col-lg col-sm-4">
                        <div class="card cuoicung">
                            <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                                ...
                                <img class="card-img-top anh" src="user/images/dai-dich-tren-con-duong-to-lua.jpg"
